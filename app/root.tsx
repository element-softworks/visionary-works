...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  return json<Data>(
      ...
      {
        headers: {
          'Set-Cookie': await messageSession.destroySession(session),
        },
      }
  );
};
...
const App = () => {
  const { message: _message } = useLoaderData<Data>();
  const [message, setMessage] = useState<Message | null>(_message);
