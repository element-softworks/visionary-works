...
import { Card, Avatar, CardMedia, CardContent, Typography, Button, Box } from '@mui/material';
...
const ContentCard: React.FC<{ testimonial?: Testimonial; blog?: Blog; readMore?: string }> = ({
	testimonial,
	blog,
	readMore,
}) => {
