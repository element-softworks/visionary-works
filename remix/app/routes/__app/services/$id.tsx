	...
	return (
		<Styles>
				...
				<Container>
					<Grid container>
						<Grid item sm={6}>
							...
							<Typography className="service-subtitle" variant="h2">
						...
						<Grid item sm={6}>
							<Box className="service-icon-background">
								{!!service?.data?.attributes?.icon && (
									<FontAwesomeIcon
										icon={['fad', service?.data?.attributes?.icon as IconName]}
									/>
								)}
							</Box>
						</Grid>
			...
			<Box className="service-content">
				<Container>
					<Grid container className="service-content-wrapper" spacing={2}>
						<Grid item sm={7}>
							<Typography className="service-subtitle" variant="h3">
								{service?.data?.attributes?.contentTitle}
							</Typography>
							{reactContent}
						</Grid>
						<Grid item sm={5}>
							<img
								src={service?.data?.attributes?.coverImage?.data?.attributes?.url}
					...
					<Typography className="service-what-can-we-provide" variant="h4">
						What can we provide?
					</Typography>
			...
			<Box className="projects-related">
				<Container>
					<Typography className="projects-related-title" variant="h4">
						Checkout our recent {service?.data?.attributes?.title} projects
					</Typography>
				</Container>
				<Slider>
			...
			<Box className="faqs">
				<Container>
					<Typography className="service-subtitle" variant="h4">
						Got a {service?.data?.attributes?.title} related question?
					</Typography>
					<FaqsList />
				</Container>
			</Box>
